...
OUTPUT_DIR = ROOT / "code" / "model" / "outputs_drop_features_first_time_borrower"
TARGET_COL = "target"
...
FEATURES_TO_DROP = {
    ...
    # repayment derived (always invalid)
    "repayment_intensity",
    "burden_percentile",
...
def evaluate_models(dataset_name: str, data_path: Path) -> None:
    print(f"=== Training (drop features) on {dataset_name} dataset ===")
